 ...
 *
 * Names of {@linkplain
 * tripleo.elijah.javac_model.lang.model.element.ExecutableElement#getParameters()
 * parameters} may not be recoverable from class files.
 *
 * The {@linkplain tripleo.elijah.javac_model.lang.model.element.Modifier modifiers} on an
 ...
 * tripleo.elijah.javac_model.lang.model.util.Elements.Origin#MANDATED mandated} may not be
 * marked as such when created from class files.
 *
 * Additionally, {@linkplain
 * tripleo.elijah.javac_model.lang.model.util.Elements.Origin#SYNTHETIC synthetic}
 * constructs in a class file, such as accessor methods used in
 * implementing nested classes and {@linkplain
 * tripleo.elijah.javac_model.lang.model.util.Elements.Origin#isBridge(ExecutableElement)
 ...
 *
 * @see tripleo.elijah.javac_model.lang.model.util.Elements
