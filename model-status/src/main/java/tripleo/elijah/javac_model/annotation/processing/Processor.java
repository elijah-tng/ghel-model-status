 ...
 * tripleo.elijah.javac_model.annotation.processing.RoundEnvironment rounds}.  On each
 ...
 * controlled.  For example, for a {@link tripleo.elijah.javac_model.tools.JavaCompiler
 * JavaCompiler} the list of candidate processors to run can be
 * {@linkplain tripleo.elijah.javac_model.tools.JavaCompiler.CompilationTask#setProcessors
 * set directly} or controlled by a {@linkplain
 * tripleo.elijah.javac_model.tools.StandardLocation#ANNOTATION_PROCESSOR_PATH search path}
...
public interface Processor {
     ...
     * tripleo.elijah.javac_model.lang.model.SourceVersion#isIdentifier identifiers}:
     *
     * <blockquote>
     * <dl>
     ...
     *         empty set if none
     * @see tripleo.elijah.javac_model.annotation.processing.SupportedOptions
     */
     ...
     * tripleo.elijah.javac_model.annotation.processing.ProcessingEnvironment#getSourceVersion
     ...
     * @see tripleo.elijah.javac_model.annotation.processing.SupportedAnnotationTypes
     * @jls 3.8 Identifiers
     */
     ...
     * processor}
     *
     * @see tripleo.elijah.javac_model.annotation.processing.SupportedSourceVersion
    ...
    * <blockquote>
    * <pre>
    * import static tripleo.elijah.javac_model.annotation.processing.Completions.*;
    * ...
