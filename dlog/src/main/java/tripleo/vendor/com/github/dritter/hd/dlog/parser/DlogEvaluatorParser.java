...
public class DlogEvaluatorParser {
    ...
    private Map<Predicate, tripleo.vendor.com.github.dritter.hd.dlog.evaluator.IFacts> factsResult = new HashMap<Predicate, tripleo.vendor.com.github.dritter.hd.dlog.evaluator.IFacts>();
    ...
    public final Collection<tripleo.vendor.com.github.dritter.hd.dlog.evaluator.IFacts> getFacts() {
        final List<tripleo.vendor.com.github.dritter.hd.dlog.evaluator.IFacts> facts = new ArrayList<tripleo.vendor.com.github.dritter.hd.dlog.evaluator.IFacts>();
        for (final Entry<Predicate, tripleo.vendor.com.github.dritter.hd.dlog.evaluator.IFacts> entry : this.factsResult.entrySet()) {
