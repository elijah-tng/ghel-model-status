 ...
 * tripleo.elijah.javac_model.lang.model.util.Elements#getFileObjectOf(Element) reference
 ...
 * tripleo.elijah.javac_model.annotation.processing.Filer#createSourceFile(CharSequence,
 * Element...) source code} or {@linkplain
 * tripleo.elijah.javac_model.annotation.processing.Filer#createClassFile(CharSequence,
 * Element...) class files} written by a processor
 * <li>{@linkplain
 * tripleo.elijah.javac_model.lang.model.util.Elements#getAllPackageElements(CharSequence)
 * queried for} in the configured environment
 * </ul>
 *
 * @see tripleo.elijah.javac_model.lang.model.util.Elements#getPackageOf
 * @since 1.6
 */
public interface PackageElement extends Element, QualifiedNameable {
    /**
     * {@return a {@linkplain tripleo.elijah.javac_model.lang.model.type.NoType pseudo-type}
     * for this package}
     *
     * @see tripleo.elijah.javac_model.lang.model.type.NoType
     * @see tripleo.elijah.javac_model.lang.model.type.TypeKind#PACKAGE
     */
    @Override
    TypeMirror asType();
