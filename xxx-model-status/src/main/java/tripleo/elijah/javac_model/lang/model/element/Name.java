 ...
 * tripleo.elijah.javac_model.annotation.processing.ProcessingEnvironment annotation
 * processing}, the guarantees for "the same" implementation must
 * include contexts where the {@linkplain tripleo.elijah.javac_model.annotation.processing
 * API mediated} side effects of {@linkplain
 * tripleo.elijah.javac_model.annotation.processing.Processor processors} could be visible
 * to each other, including successive annotation processing
 * {@linkplain tripleo.elijah.javac_model.annotation.processing.RoundEnvironment rounds}.
 *
 * @see tripleo.elijah.javac_model.lang.model.util.Elements#getName
 * @since 1.6
 */
