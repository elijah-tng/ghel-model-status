 ...
 * ({@link tripleo.elijah.javac_model.tools.DiagnosticListener}) as well as a file
 * abstraction for overriding file access ({@link
 * tripleo.elijah.javac_model.tools.JavaFileManager} and {@link
 * tripleo.elijah.javac_model.tools.JavaFileObject}).  See {@link
 * tripleo.elijah.javac_model.tools.JavaCompiler} for more details on using the SPI.
 *
 * <p>There is no requirement for a compiler at runtime.  However, if
 * a default compiler is provided, it can be located using the
 * {@link tripleo.elijah.javac_model.tools.ToolProvider}, for example:
 *
 ...
 * META-INF/services/tripleo.elijah.javac_model.tools.JavaCompiler}.  This file would
